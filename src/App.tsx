...
export default function App() {
  ...
  async function handleChange(next: MonthSchedule) {
    setSchedule(next);
    try {
        ...
        <>
          {mode === 'auto' && (
            <div style={{ marginBottom: 16 }}>
              <button onClick={handleAutoGenerate}>Wygeneruj grafik automatycznie</button>
          ...
          <ScheduleTable employees={employees} schedule={schedule} onChange={handleChange} />
